...
| 主页 | 对话 | 添加平台 | 设置 |
|:----:|:----:|:------:|:----:|
| <img src="docs/assets/screenshot_home.jpg" alt="主页" width="200"/> | <img src="docs/assets/screenshot_chat_screen.jpg" alt="对话" width="200"/> | <img src="docs/assets/screenshot_add_platform.jpg" alt="添加平台" width="200"/> | <img src="docs/assets/screenshot_setting.jpg" alt="设置" width="200"/> |
...
- [ ] 更丰富的 UI 组件模板 — 覆盖更多常见工具类应用的界面模式
- [ ] 更智能的自动修复 — 覆盖更广的错误场景，提升首次生成成功率
- [ ] 工具类应用能力增强 — 网络请求、本地存储、定时任务等常用能力支持
- [ ] 爬虫与数据工具 — 基于 jsoup 的结构化数据抓取与展示
- [ ] 持续迭代能力 — 通过多轮对话持续打磨已生成的应用
- [ ] 社区模板市场 — 分享和复用优质工具模板
