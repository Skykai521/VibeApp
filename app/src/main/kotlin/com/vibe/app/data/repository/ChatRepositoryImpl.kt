...
import com.vibe.app.data.dto.anthropic.common.ImageContent as AnthropicImageContent
...
import com.vibe.app.data.dto.anthropic.common.MessageContent as AnthropicMessageContent
import com.vibe.app.data.dto.anthropic.common.MessageRole
import com.vibe.app.data.dto.anthropic.common.TextContent as AnthropicTextContent
import com.vibe.app.data.dto.anthropic.request.InputMessage
import com.vibe.app.data.dto.anthropic.request.MessageRequest
import com.vibe.app.data.dto.google.common.Content
import com.vibe.app.data.dto.google.common.Part
import com.vibe.app.data.dto.google.common.Role as GoogleRole
import com.vibe.app.data.dto.google.request.GenerateContentRequest
import com.vibe.app.data.dto.google.request.GenerationConfig
import com.vibe.app.data.dto.openai.common.ImageContent as OpenAIImageContent
import com.vibe.app.data.dto.openai.common.ImageUrl
import com.vibe.app.data.dto.openai.common.MessageContent as OpenAIMessageContent
import com.vibe.app.data.dto.openai.common.Role as OpenAIRole
import com.vibe.app.data.dto.openai.common.TextContent as OpenAITextContent
...
class ChatRepositoryImpl @Inject constructor(
    ...
    override suspend fun completeChat(
        ...
        ClientType.GROQ, ClientType.OLLAMA, ClientType.OPENROUTER, ClientType.CUSTOM, ClientType.KIMI, ClientType.MINIMAX -> {
    ...
    private suspend fun completeChatWithAnthropic(
        ...
        val request = MessageRequest(
            ...
            thinking = if (platform.reasoning) {
                com.vibe.app.data.dto.anthropic.request.ThinkingConfig(
                    type = "enabled",
                    budgetTokens = 10000
                )
            } else {
        ...
        val request = GenerateContentRequest(
            ...
            generationConfig = GenerationConfig(
                ...
                thinkingConfig = if (platform.reasoning) {
                    com.vibe.app.data.dto.google.request.ThinkingConfig(
